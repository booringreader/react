                ...
                <div key={item?.card?.info?.id} className="p-2 m-2 border-gray-300 border-b-2 text-left">
                    <div className="py-1 flex justify-between">
                        ...
                        <div className="relative">
                            ...
                            <button className="absolute left-[1px] bottom-1 bg-white text-green-600 px-5 py-[2px] rounded-lg shadow-lg transform -translate-y-1/4 -translate-x-1/4">ADD</button>
                        </div>
                    </div>
                </div>
            ))}
